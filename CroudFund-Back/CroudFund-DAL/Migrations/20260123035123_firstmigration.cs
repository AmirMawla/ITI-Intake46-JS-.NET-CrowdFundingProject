...
namespace CroudFund_DAL.Migrations
{
    /// <inheritdoc />
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    GoalAmount = table.Column<decimal>(type: "decimal(18,0)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Payments_Pledges_PledgeId",
                        column: x => x.PledgeId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Reviews_CampaignId_UserId",
                table: "Reviews",
